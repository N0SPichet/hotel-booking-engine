...
class DiaryComponentController extends Controller
{
    ...
    public function categories_index()
    {
        ...
        return view('admin.components.categories.index')->with('categories', $categories);
    }
    ...
    public function categories_show($id)
    {
        ...
        if (!is_null($category)) {
        	return view('admin.components.categories.show')->with('category', $category);
        }
        return redirect()->route('comp.categories.index');
    }
    ...
    public function categories_edit($id)
    {
        $category = Category::find($id);
        if (!is_null($category)) {
        	return view('admin.components.categories.edit')->with('category', $category);
        }
        return redirect()->route('comp.categories.index');
    }
    ...
    public function tags_index()
    {
        ...
        return view('admin.components.tags.index')->with('tags', $tags);
    }
    ...
    public function tags_show($id)
    {
        $tag = Tag::find($id);
        if (!is_null($tag)) {
        	return view('admin.components.tags.show')->with('tag', $tag);
        }
        return redirect()->route('comp.tags.index');
    }
    ...
    public function tags_edit($id)
    {
        $tag = Tag::find($id);
        if (!is_null($tag)) {
        	return view('admin.components.tags.edit')->with('tag', $tag);
        }
        return redirect()->route('comp.tags.index');
    }
