...
class RoomComponentController extends Controller
{
    ...
    public function amenities_index()
    {
        ...
        return view('components.amenities.index')->with('amenities', $amenities);
    }
    ...
    public function amenities_show($id)
    {
        ...
        if (!is_null($amenity)) {
        	return view('components.amenities.show')->with('amenity', $amenity);
        }
        return redirect()->route('comp.amenities.index');
    }
    ...
    public function amenities_edit($id)
    {
        $amenity = Houseamenity::find($id);
        if (!is_null($amenity)) {
        	return view('components.amenities.edit')->with('amenity', $amenity);
        }
        return redirect()->route('comp.amenities.index');
    }
    ...
    public function details_index()
    {
        ...
        return view('components.details.index')->with('details', $details);
    }
    ...
    public function details_show($id)
    {
        ...
        if (!is_null($detail)) {
        	return view('components.details.show')->with('detail', $detail);
        }
        return redirect()->route('comp.details.index');
    }
    ...
    public function details_edit($id)
    {
        $detail = Housedetail::find($id);
        if (!is_null($detail)) {
        	return view('components.details.edit')->with('detail', $detail);
        }
        return redirect()->route('comp.details.index');
    }
    ...
    {
        $rules = Houserule::all();
        return view('components.rules.index')->with('rules', $rules);
    }
    ...
    public function rules_show($id)
    {
        ...
        if (!is_null($rule)) {
        	return view('components.rules.show')->with('rule', $rule);
        }
        return redirect()->route('comp.rules.index');
    }
    ...
    public function rules_edit($id)
    {
        $rule = Houserule::find($id);
        if (!is_null($rule)) {
        	return view('components.rules.edit')->with('rule', $rule);
        }
        return redirect()->route('comp.rules.index');
    }
