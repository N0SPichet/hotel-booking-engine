			...
			<div class="tab-content">
		    	<div id="menu1" class="tab-pane fade in active">
		    		<div class="col-md-10 col-md-offset-1 margin-top-10">
		    			...
		    			<h2>Basic</h2>
		    			{{ Form::label('house_property', '* Is this listing a home, hotel, or something else?', ['class' => 'margin-top-10']) }}
						<select class="form-control margin-top-10" name="house_property">
						...
						{{ Form::label('house_capacity', '* How many guests can your place accommodate?', ['class' => 'margin-top-10']) }}
						...
						<h2>Rooms</h2>
						{{ Form::label('house_bedrooms', '* How many bedrooms can guests use?', ['class' => 'margin-top-10']) }}
						...
						{{ Form::label('house_beds', '* How many beds can guests use?', ['class' => 'margin-top-10']) }}
						...
						{{ Form::label('house_bathroom', '* How many bathrooms?', ['class' => 'margin-top-10']) }}
		    	...
		    	<div id="menu7" class="tab-pane fade">
		    		<div class="col-md-10 col-md-offset-1 margin-top-10">
						...
						{{ Form::label('price', '* Room price (THB)', ['class' => 'margin-top-10']) }}
						{{ Form::text('price', null, ['class' => 'form-control margin-top-10', 'placeholder' => '1234', 'required' => '']) }}

						{{ Form::label('food_price', '* Food price (THB) (optional)', ['class' => 'margin-top-10']) }}
						{{ Form::text('food_price', null, ['class' => 'form-control margin-top-10', 'placeholder' => '1234']) }}
						...
						{{ Form::label('weekly_discount', '* Weekly discount (%)', ['class' => 'margin-top-10']) }}
						{{ Form::text('weekly_discount', null, ['class' => 'form-control margin-top-10', 'placeholder' => '10%']) }}

						{{ Form::label('monthly_discount', '* Monthly discount (%)', ['class' => 'margin-top-10']) }}
						{{ Form::text('monthly_discount', null, ['class' => 'form-control margin-top-10', 'placeholder' => '10%']) }}
		    		</div>
		    	</div>
		    </div>
		</div>
