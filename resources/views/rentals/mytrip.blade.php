			...
			<div class="card m-t-10">
				<div class="margin-content">
					<div class="col-md-5 float-left">
						...
						@endif
						<p>@if($rental->houses->checkType($rental->houses->id)) <img src="{{ asset('images/houses/house.png')}}" style="height: 20px; width: 20px; margin-bottom: 10px;"> @elseif($rental->houses->housetypes_id == 1) <img src="{{ asset('images/houses/apartment.png')}}" style="height: 20px; width: 20px; margin-bottom: 10px;"> @endif Room Name :  {{ $rental->houses->house_title }}  </p>
