	...
	<div align="left" style="background-color: powderblue;">
		<div style="padding: 20px;">
			...
			<ul>
				...
				<li>Price : {{ $house->houseprices->price }} Thai Baht/Night</li>
				@else
				<li>
					...
					<p>Price : {{ $house->apartmentprices->single_price }} Thai Baht/Night</p>
					@endif
					...
					<p>Price : {{ $house->apartmentprices->deluxe_single_price }} Thai Baht/Night</p>
					@endif
					...
					<p>Price : {{ $house->apartmentprices->double_price }} Thai Baht/Night</p>
				</li>
				@endif
				@endif
			</ul>
