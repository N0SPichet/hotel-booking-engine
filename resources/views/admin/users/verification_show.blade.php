...
<div class="container">
	<div class="row m-t-10">
		<div class="col-sm-12">
			<a href="{{ route('admin.users.verify-index') }}" class="btn btn-outline-secondary"><i class="fas fa-chevron-left"></i> Back to Users</a>
		</div>
	</div>
	<div class="row m-t-10">
		<div class="col-md-12">
		...
		<div class="col-md-4 float-left">
			<div class="well" align="center">
				...
				{!! Form::open(['route' => ['admin.users.verify-approve', $user->id]]) !!}
